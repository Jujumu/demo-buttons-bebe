...
DATABASE_FUNCTIONS = ('claim_job claim_owner_alert finish_owner_alert get_job_result complete_job fail_job get_next_pending_job get_job_stats init_db requeue_stale_jobs').split()
