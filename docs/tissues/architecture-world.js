    ...
    tissues: [
      {
        name: "View",
        shape: "cards",
        kid: "Picks which pile of tickets you are looking at: Assigned to me, Unassigned, Open, Escalated, All, Snoozed, Closed, Trash.",
...
function drawInboxWireframe() {
  ...
  const views = ["Assigned to me", "Unassigned", "Open", "Escalated", "All", "Snoozed", "Closed", "Trash"];
