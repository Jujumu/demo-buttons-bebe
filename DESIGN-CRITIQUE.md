...
> **Ported from the `Fable_buttonsbebe` branch on 2026-07-29 (Task 7 of the Fable port).**
> This document predates the port and talks about two parallel tracks:
> **Track A** is the live VPS system you run today — the Gorgias + Hermes + KB
> pipeline in this repo. **Track B** is Fable, the standalone help-desk
> prototype, which stayed on its branch and is **not** part of `main`. Read
> anything Track B says as background, not as planned work. The parts of Track A
> this document argues for were ported in Tasks 1-6; see
> `PORTFROMFABLETASKLIST.md` for what shipped and what did not.
