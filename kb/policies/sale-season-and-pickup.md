---
title: Sale Season, Warehouse Locations & Pickup
category: policies
status: confirmed
source: derived-from-tickets
tags: [sale-season, warehouse, pickup, drop-off, hours, contacts, locations, exchange]
---

## Sale-season return rules

During an active site-wide sale, **returns by mail are not accepted** — only
**in-warehouse (in-person) exchanges** are available. Also during sale season,
**order processing can take 4–5 business days** due to high volume (vs. the normal
24–48 hour processing time). If unsure whether a sale is active, check current
promotions or ask the team. See `return-and-exchange-policy.md` for the
final-sale/warehouse-exchange exception.
